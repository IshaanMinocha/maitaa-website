        ...
        <>
            ...
            <nav className="w-full z-20 drop-shadow-lg bg-light">
                <div className="flex flex-wrap gap-4 px-2 sm:flex-nowrap items-center justify-between">
                    <NavLink to="/" className="flex items-center space-x-3 rtl:space-x-reverse mx-auto md:mx-0">
                        <img src="/main-logo.png" className="h-20 md:h-24 m-2" alt="MAITAA" />
                    </NavLink>
            ...
            <div className="sticky top-0 flex flex-wrap flex-row bg-secondary h-16 justify-center items-center z-50">
                <div className="items-center justify-between w-max md:flex" id="navbar-sticky">
                    <ul className="flex flex-row text-sm md:text-xl font-bold md:space-x-16 space-x-0 divide-x-2">
                        <li>
                            <NavLink to="/" style={navLinkStyles} className="block py-2 px-3 rounded md:p-0" aria-current="page">Home</NavLink>
                        </li>
                        <li>
                            <NavLink to="/about" style={navLinkStyles} className="md:ml-16 block py-2 px-3 rounded md:p-0">About</NavLink>
                        </li>
                        {/* <li>
                                    <NavLink to="/events" style={navLinkStyles} className="xl:ml-16 ml-10 block py-2 px-3 rounded md:p-0">Events</NavLink>
                                </li> */}
                        <li>
                            <NavLink to="/gallery" style={navLinkStyles} className="md:ml-16 block py-2 px-3 rounded md:p-0">Gallery</NavLink>
                        </li>
                        {/* <li>
                                    <NavLink to="/donations" style={navLinkStyles} className="xl:ml-16 ml-10 block py-2 px-3 rounded md:p-0">Donations</NavLink>
                                </li> */}
                        <li>
                            <NavLink to="/contact" style={navLinkStyles} className="md:ml-16 block py-2 px-3 rounded md:p-0">Contact</NavLink>
                        </li>
                    </ul>
                </div>
            </div>
