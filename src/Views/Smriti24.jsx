    ...
    <div className='bg-light text-dark'>
      <div className="flex flex-col items-center bg-[url('/smriti-bg2.jpg')] bg-no-repeat bg-fixed bg-cover">
        <nav className="fixed top-10 w-[300px] sm:w-full sm:max-w-2xl rounded-3xl border-2 border-secondary bg-light shadow-lg z-50">
          <div className="mx-auto flex justify-between items-center py-4 px-6">
            <div className="flex items-center">
              <NavLink to="/smriti25" className="font-semibold font-subhead text-4xl text-dark">Smriti</NavLink>
            </div>
        ...
        <section className="mt-40">
          <div className="px-4 mx-auto max-w-screen-xl text-center ">
            <h1 className="mb-4 text-8xl font-extrabold tracking-widest font-normaltext text-dark">MAIT SMRITI 2k25</h1>
            <p className="mb-16 text-4xl font-semibold font-subhead tracking-widest text-secondary">RELIVE | REJOICE | RECONNECT</p>
          </div>
          {/* <motion.svg
        ...
        <div className="w-[99vw]">
          <h1 className="my-2 text-3xl text-dark text-center">SEE YOU IN</h1>
      ...
      <footer className="footer md:justify-between items-center p-4 bg-light text-dark shadow-xl">
        <aside className="items-center grid-flow-col">
          ...
          </a> | © 2025 <a className='hover:underline font-bold text-secondary' href='https://mait.ac.in/'>
              MAIT
            </a>
          </p>
        </aside>
